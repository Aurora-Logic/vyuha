...
export const METRIC_REGISTRY: readonly MetricDefinition[] = [
  ...
  { id: 'M06', label: 'Landed cost', technicalName: 'landed_cost', meaning: 'The cost of the goods sold: the Tally item master’s cost price, confirmed as the authoritative basis by the owner on 28 Aug 2026 (closes open decision M1).', formula: 'Σ qty × stock item cost price; null when any line of a grain has no cost', source: FACT, unit: 'money', good: 'down', excludes: 'Grains with any uncosted line, ledger-only vouchers, credit notes: their margin is null, never zero.', permission: 'cfo.margin.view', version: 2, effectiveFrom: '2026-08-28', builtIn: 'Margin, pivot', related: ['M07'] },
  { id: 'M07', label: 'Pocket margin', technicalName: 'pocket_margin', meaning: 'Pocket price less landed cost on the confirmed Tally item-cost basis (M1 closed 28 Aug 2026), on costed grains only, beside its coverage. K3: rupees need cfo.margin.view; a salesperson sees the percentage on their own book.', formula: 'M05 − M06, per grain; coverage = costed net ÷ net', source: FACT, unit: 'money', good: 'up', materialityFloor: 25_000, permission: 'cfo.margin.view', version: 2, effectiveFrom: '2026-08-28', builtIn: 'Margin, league, scorecard, My CFO, pivot', related: ['M05', 'M06'] },
  ...
  { id: 'X02', label: 'Desk priority score', technicalName: 'desk_score', meaning: 'Which customers to work on today, 0-100.', formula: 'value (log-scaled, × class multiplier) × 35 + urgency (max of overdue/90, days past gap/60) × 30 + risk × 20 + opportunity × 15 − 40 on cooldown', source: 'work lists, trailing-12m sales, promises, desk outcomes, customer class', unit: 'score', good: 'none', excludes: 'Opportunity is the class\u2019s cross-sell estimate (M12): categories at least half the class buys, priced at the class median.', permission: SALES, version: 2, effectiveFrom: '2026-08-28', builtIn: 'Director’s desk', related: ['D10', 'C12', 'D18'] },
  { id: 'M10', label: 'Price bands', technicalName: 'price_bands', meaning: 'What each SKU actually sold at: min, quartiles, median and max of line rates.', formula: 'percentiles of voucher line rates per SKU, 3+ priced lines', source: 'Sales voucher lines with a rate', unit: 'money', good: 'none', minimumSample: '3 priced lines per SKU', permission: SALES, version: 1, effectiveFrom: '2026-08-28', builtIn: 'Analytics', related: ['M11'] },
  { id: 'M11', label: 'Price realisation gap', technicalName: 'realisation_gap', meaning: 'What selling every below-median line at the median would have recovered.', formula: 'Σ max(0, median − rate) × qty per SKU', source: 'Sales voucher lines', unit: 'money', good: 'down', permission: SALES, version: 1, effectiveFrom: '2026-08-28', builtIn: 'Analytics', related: ['M10'] },
  { id: 'M12', label: 'Cross-sell estimate', technicalName: 'cross_sell', meaning: 'For a customer and a category they do not buy: how many of their class buy it, priced at the class median annual spend. Feeds the desk score and the call sheet.', formula: 'classes of 4+, categories with 50%+ adoption, median spend', source: FACT, unit: 'money', good: 'none', minimumSample: '4 customers in the class; 50% adoption', permission: SALES, version: 1, effectiveFrom: '2026-08-28', builtIn: 'Desk, call sheet, analytics' },
  { id: 'C10', label: 'Concentration', technicalName: 'concentration', meaning: 'The share of trailing-12-month sales the top five and top ten customers carry, against last year.', formula: 'top-N net ÷ total net', source: FACT, unit: 'pct', good: 'down', permission: SALES, version: 1, effectiveFrom: '2026-08-28', builtIn: 'Analytics, alerts', related: ['C11'] },
  { id: 'C11', label: 'HHI', technicalName: 'hhi', meaning: 'One risk number: the sum of squared revenue shares. Above 2,500 is concentrated by any convention.', formula: 'Σ (share ×100)²', source: FACT, unit: 'count', good: 'down', permission: SALES, version: 1, effectiveFrom: '2026-08-28', builtIn: 'Analytics', related: ['C10'] },

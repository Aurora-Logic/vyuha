...
export const ANCHORS = {
  ...
  screenChart: 'screen.chart',
  screenRowActions: 'screen.row-actions',
  screenSavedViews: 'screen.saved-views',
  screenBoard: 'screen.board',
  screenMatrix: 'screen.matrix',
  screenAttachments: 'screen.attachments',
...
const FURNITURE_STEPS: GuideStep[] = [
  {
    id: 'furniture.presence',
    anchor: ANCHORS.screenPresence,
    furniture: true,
    title: 'Who else is here',
    body: 'These faces are colleagues looking at this record right now. Their edits arrive without you reloading.',
  },
  {
    id: 'furniture.tabs',
    anchor: ANCHORS.screenTabs,
    furniture: true,
    title: 'The views of this screen',
    body: 'The same records read a different way. The actions on the right belong to whichever tab is open.',
  },
  {
    id: 'furniture.saved-views',
    anchor: ANCHORS.screenSavedViews,
    furniture: true,
    title: 'Keep a set of filters',
    body: 'Once the filters say what you want, save the arrangement and come back to it by name instead of setting it again.',
  },
  {
    id: 'furniture.search',
  ...
  {
    id: 'furniture.kpis',
    anchor: ANCHORS.screenKpis,
    furniture: true,
    title: 'The headline figures',
    body: 'The numbers this screen exists to answer, for the period and filters you have set. Change a filter and these change with the rows.',
  },
  {
    id: 'furniture.chart',
    anchor: ANCHORS.screenChart,
    furniture: true,
    title: 'The same data as a shape',
    body: 'A trend is easier to read than a column of figures. Hovering a point gives you the exact number behind it.',
  },
  {
    id: 'furniture.board',
    anchor: ANCHORS.screenBoard,
    furniture: true,
    title: 'The board',
    body: 'The same records as columns you can drag between. Moving a card is the same edit as changing its status in the list.',
  },
  {
    id: 'furniture.matrix',
    anchor: ANCHORS.screenMatrix,
    furniture: true,
    title: 'Read across two dimensions',
    body: 'A grid where the colour carries the number, so a pattern across rows and columns shows up without reading every cell.',
  },
  {
    id: 'furniture.table',
  ...
  {
    id: 'furniture.row-actions',
    anchor: ANCHORS.screenRowActions,
    furniture: true,
    title: 'What you can do to one row',
    body: 'Everything that acts on a single record lives behind this, rather than as a row of buttons repeated down the screen.',
  },
  {
    id: 'furniture.attachments',
    anchor: ANCHORS.screenAttachments,
    furniture: true,
    title: 'Files on this record',
    body: 'Attached here rather than sent separately, so whoever picks the record up next has what was sent with it.',
  },
  {

...
const TEMPLATES: Record<Exclude<DocumentTemplateId, 'tally'>, TemplateStyle> = {
  formal: {
    sheet: 'p-[14mm]',
    frame: '',
    header: 'flex items-start justify-between gap-6 border-b-2 border-neutral-900 pb-4',
    title: 'text-[1.5em] font-semibold uppercase tracking-[0.18em]',
    business: 'text-right',
    metaBox: 'grid grid-cols-[auto_1fr] gap-x-4 gap-y-0.5',
    metaLabel: 'text-[0.8em] uppercase tracking-wider text-neutral-500',
    tableHeadCell: 'border-b-2 border-neutral-900 pb-1.5 text-[0.78em] font-semibold uppercase tracking-wider text-neutral-600',
    row: 'border-b border-neutral-200',
    cell: 'align-top py-2.5',
    summaryHead: 'border-b-2 border-neutral-900 text-[0.78em] font-semibold uppercase tracking-wider text-neutral-600',
    summaryCell: 'border-b border-neutral-200 py-1',
    totalsBox: 'ml-auto w-[38%] min-w-[220px] border-t-2 border-neutral-900 pt-2',
    grandTotal: 'mt-1 border-t border-neutral-300 pt-1.5 text-[1.2em] font-semibold',
    footer: 'border-t border-neutral-300 pt-4 text-[0.85em] text-neutral-500',
    section: 'text-[0.78em] font-semibold uppercase tracking-[0.14em] text-neutral-500',
    body: 'pt-6',
  },
  compact: {
    sheet: 'p-[10mm]',
    frame: '',
    header: 'flex items-start justify-between gap-4 pb-3',
    title: 'text-[1.2em] font-semibold tracking-tight',
    business: 'text-right text-[0.9em]',
    metaBox: 'grid grid-cols-[auto_1fr] gap-x-2 gap-y-0',
    metaLabel: 'text-[0.8em] text-neutral-500',
    tableHeadCell: 'border-y border-neutral-400 py-0.5 text-[0.75em] font-semibold uppercase tracking-wide',
    row: 'border-b border-neutral-200',
    cell: 'align-top py-1',
    summaryHead: 'border-y border-neutral-400 py-0.5 text-[0.75em] font-semibold uppercase tracking-wide',
    summaryCell: 'border-b border-neutral-200 py-0.5',
    totalsBox: 'ml-auto w-[36%] min-w-[200px] pt-1',
    grandTotal: 'border-t border-neutral-800 pt-1 text-[1.1em] font-semibold',
    footer: 'pt-3 text-[0.8em] text-neutral-500',
    section: 'text-[0.75em] font-semibold uppercase tracking-wide text-neutral-500',
    body: 'pt-4',
  },
  executive: {
    sheet: 'p-[12mm]',

...
export function sampleSettings(): OrgSettings {
  ...
  appearance: { accentHue: 277, accentChroma: 0.24, base: 'stone', density: 'comfortable', font: 'sans' },
    email: {
      ...
      port: 1025,
      secure: false,
      from: 'vyuha@example.com',
      credentialsConfigured: false,
    },
    enforcement: {
      attendance: {
        geofenceBehaviour: 'Punch pipeline',
        deviceBindingMode: 'Punch pipeline',
        maxWorkMinutes: 'Day engine',
        regularizationWindowDays: 'Regularization',
        regularizationMaxPerMonth: 'Regularization',
        regularizationAutoFile: 'Regularization',
        earlyArrivalEnabled: 'Punch pipeline',
        earlyArrivalThresholdMinutes: 'Punch pipeline',
        autoEscalationDays: 'Approvals framework',
      },
      photo: {
        retentionMonths: 'Punch photo pipeline',
    ...
    interest: {
      ...
      stockAnnualRatePct: 'Stock interest reports',
      stockHoldingPeriodDays: 'Stock interest reports',
